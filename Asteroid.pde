  ...
  public Asteroid()
    {
       ...
       int [] xS = {(int)myCenterX, (int)myCenterX+32, (int)myCenterX+16, (int)myCenterX-16, (int)myCenterX-32};
       int [] yS = {(int)myCenterY+32, 0, (int)myCenterY-32, (int)myCenterY-32, 0};
       xCorners = xS;
       yCorners = yS;
       ...
       myPointDirection = 0;
       myRotateSpeed = (int)(Math.random()*21)-11;
    }
